...
from .views import pagina_principal, nuevo_usuario, lista_libros, detalles_libro, lista_autores, detalles_autor, detalles_lector, leer_capitulo, crear_libro, editar_libro, eliminar_libro, crear_capitulo, editar_capitulo, eliminar_capitulo, crear_autor, editar_autor, eliminar_autor, crear_lector, editar_lector, eliminar_lector
...
urlpatterns = [
    ...
    path("lector/<int:pk>", detalles_lector.as_view(), name="lector"),
